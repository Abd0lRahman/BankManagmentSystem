...
"color: rgb(255, 170, 255);"));
        ...
        horizontalLayout90->addWidget(PB_LogOut);
...
"color: rgb(255, 170, 255);"));
        ...
        Logo2 = new QLabel(EmtyPage);
        Logo2->setObjectName("Logo2");
        Logo2->setGeometry(QRect(0, 10, 561, 411));
        ...
        BankLogoLabel = new QLabel(MainAdminWin);
        BankLogoLabel->setObjectName("BankLogoLabel");
        BankLogoLabel->setGeometry(QRect(10, 390, 241, 161));
    ...
    {
        MainAdminWin->setWindowTitle(QCoreApplication::translate("MainAdminWin", "Admin view", nullptr));
        ...
        PB_LogOut->setText(QCoreApplication::translate("MainAdminWin", "Log out", nullptr));
