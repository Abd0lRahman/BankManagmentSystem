    ...
    , ui(new Ui::MainAdminWin)
{
    ...
    ui->BankLogoLabel->setPixmap(QPixmap("BankLogo.PNG").scaled(240,161,Qt::KeepAspectRatio, Qt::SmoothTransformation));
}
...
void MainAdminWin::on_PB_LogOut_clicked()
{
    this->accept();
}
