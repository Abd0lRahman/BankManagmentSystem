...

{
    ...
    ui->Connectionlabel_2->setText("Server is connected");
}

void Login::OnDisConnect()
{
    ui->Connectionlabel->setText("Server is disconnected");
    ui->Connectionlabel_2->setText("Server is disconnected");
}
...
void Login::OnErrorOccurred(QAbstractSocket::SocketError error)
{
    ...
    ui->Connectionlabel_2->setText(meta.valueToKey(error));
}
...
void Login::OnStateChange(QAbstractSocket::SocketState state)
{
    ...
    ui->Connectionlabel_2->setText(meta.valueToKey(state));
}
void Login::ErrorInServerFiles()
{
    QMessageBox::warning(this,"Server ERROR","Please contact the specialist");
}
