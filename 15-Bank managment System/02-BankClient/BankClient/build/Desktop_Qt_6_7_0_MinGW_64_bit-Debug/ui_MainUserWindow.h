...
public:
    ...
    void setupUi(QDialog *MainUserWindow)
    {
        ...
        MainUserWindow->resize(780, 350);
        ServerStateLabel = new QLabel(MainUserWindow);
        ServerStateLabel->setObjectName("ServerStateLabel");
        ServerStateLabel->setGeometry(QRect(620, 330, 151, 20));
...
"color: rgb(255, 170, 255);"));
        ...
        stackedWidget->setGeometry(QRect(240, 100, 561, 221));
...
"font: 16pt \"Segoe UI\";"));
        ...
        TV_ViewTransactionHistory->setGeometry(QRect(10, 10, 521, 211));
    ...
    {
        MainUserWindow->setWindowTitle(QCoreApplication::translate("MainUserWindow", "User page", nullptr));
        ServerStateLabel->setText(QCoreApplication::translate("MainUserWindow", "Server is connected", nullptr));
